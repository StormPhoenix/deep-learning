...
def yolo_body(inputs, num_anchors, num_classes):
    """Create YOLO_V2 models CNN body in Keras."""
...
def yolo_head(feats, anchors, num_classes):
    ...
    # Dynamic implementation of conv dims for fully convolutional models.
...
def yolo(inputs, anchors, num_classes):
    """Generate a complete YOLO_v2 localization models."""
    num_anchors = len(anchors)
...
def yolo_eval(yolo_outputs,
              ...
              score_threshold=.6,
              iou_threshold=.5):
    """Evaluate YOLO models on given input batch and return filtered boxes."""
